...
<template>
  <div
    class="group bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden transition-all hover:shadow-md"
  ...
  >
    ...
    <div class="px-2.5 py-2 flex items-center gap-2">
      <span
        class="flex-1 min-w-0 text-xs font-medium text-gray-900 dark:text-gray-100 truncate"
        :title="livery.folderName"
      >
        {{ livery.displayName }}
      </span>
      <button
