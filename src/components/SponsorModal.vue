      ...
      <div v-if="show" class="fixed inset-0 z-[1100] flex items-center justify-center">
        ...
        >
          ...
          <div class="flex items-center justify-between mb-5">
            <div class="flex items-center space-x-2.5">
              ...
              <div>
                ...
                <p class="text-pink-500 dark:text-pink-400/80 text-xs mt-0.5">
                  {{ $t('sponsor.subtitle') }}
                </p>
              </div>
            </div>
          ...
          <div class="flex bg-gray-100 dark:bg-white/5 rounded-xl p-1 mb-5">
            ...
            >
              ...
              <svg
                ...
                viewBox="0 0 24 24"
                :fill="activeTab === 'wechat' ? '#07C160' : 'currentColor'"
              >
                <path
            ...
            >
              ...
              <svg
                ...
                :fill="activeTab === 'alipay' ? '#009FE8' : 'currentColor'"
              >
                <path
          ...
          <div class="flex flex-col items-center">
            <div
              class="w-52 h-52 bg-white rounded-xl p-2 shadow-inner border border-gray-100 dark:border-gray-600/30 overflow-hidden"
            >
