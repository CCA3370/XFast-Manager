...
const categoryConfig = computed(() => {
  const cat = props.entry.category === SceneryCategory.FixedHighPriority
  ...
  switch (cat) {
    case SceneryCategory.FixedHighPriority:
      return { label: 'SAM', color: 'text-purple-700 dark:text-purple-300', bgColor: 'bg-purple-100 dark:bg-purple-900/30' }
    case SceneryCategory.Airport:
      return { label: t('sceneryManager.categoryAirport'), color: 'text-blue-700 dark:text-blue-300', bgColor: 'bg-blue-100 dark:bg-blue-900/30' }
    case SceneryCategory.DefaultAirport:
      return { label: t('sceneryManager.categoryDefaultAirport'), color: 'text-gray-600 dark:text-gray-400', bgColor: 'bg-gray-100 dark:bg-gray-800/50' }
    case SceneryCategory.Library:
      return { label: t('sceneryManager.categoryLibrary'), color: 'text-green-700 dark:text-green-300', bgColor: 'bg-green-100 dark:bg-green-900/30' }
    case SceneryCategory.Overlay:
      return { label: t('sceneryManager.categoryOverlay'), color: 'text-yellow-700 dark:text-yellow-300', bgColor: 'bg-yellow-100 dark:bg-yellow-900/30' }
    case SceneryCategory.AirportMesh:
      return { label: t('sceneryManager.categoryAirportMesh'), color: 'text-cyan-700 dark:text-cyan-300', bgColor: 'bg-cyan-100 dark:bg-cyan-900/30' }
    case SceneryCategory.Mesh:
      return { label: t('sceneryManager.categoryMesh'), color: 'text-red-700 dark:text-red-300', bgColor: 'bg-red-100 dark:bg-red-900/30' }
    case SceneryCategory.Other:
      return { label: t('sceneryManager.categoryOther'), color: 'text-gray-600 dark:text-gray-400', bgColor: 'bg-gray-100 dark:bg-gray-800/50' }
    case SceneryCategory.Unrecognized:
      return { label: t('sceneryManager.categoryUnrecognized'), color: 'text-red-600 dark:text-red-400', bgColor: 'bg-red-100 dark:bg-red-900/40' }
    default:
      return { label: t('sceneryManager.categoryOther'), color: 'text-gray-600 dark:text-gray-400', bgColor: 'bg-gray-100 dark:bg-gray-800/50' }
  }
})
