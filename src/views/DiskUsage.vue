  ...
  <div class="h-full flex flex-col px-6 pt-3 pb-6">
    ...
    <div class="flex items-center justify-between mb-6">
      ...
      <div class="flex items-center gap-2">
        <router-link
          to="/disk-usage/output-cleanup"
          class="text-sm px-4 py-2 rounded-lg border border-slate-200 dark:border-white/10 text-slate-600 dark:text-slate-300 hover:bg-white dark:hover:bg-white/10 transition-colors"
        >
