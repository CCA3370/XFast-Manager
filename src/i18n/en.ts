export default {
  ...
  presets: {
    ...
    applyMessage: 'Apply preset "{name}"? This will restore addon, scenery, Lua, and lock states to the preset snapshot.',
    updateSnapshotTitle: 'Update Snapshot',
    updateSnapshotMessage: 'Update preset "{name}" with the current addon, scenery, Lua, and lock states?',
  ...
  csl: {
    ...
    confirmUninstall: 'Are you sure you want to uninstall {name}? This will delete all related files.',
