export default {
  ...
  patch: {
    title: 'Install aircraft patch',
    targetAircraft: 'Target aircraft',
    detecting: 'Detecting matching aircraft…',
    autoRecommended: 'Best match for this patch',
    applyTo: 'Apply to',
    summaryTitle: 'What will happen',
    filesApplied: '{count} files applied to {aircraft}',
    filesOverwritten: '{count} existing files will be overwritten',
    advancedMappings: 'Advanced · edit file mappings',
    noAircraft: 'No installed aircraft found.',
    mappings: 'File mappings',
    addMapping: 'Add mapping',
    inferring: 'Analyzing patch contents…',
    archiveRootPlaceholder: '(archive root)',
    destRootPlaceholder: '(aircraft root)',
    archiveRoot: 'archive root',
    aircraftRoot: 'aircraft root',
    unmappedHint: 'Unmapped folders — click to add a mapping:',
    backupLabel: 'Back up overwritten files',
    backupHint: 'Saves the files this patch overwrites so it can be reverted.',
    preparing: 'Preparing…',
    install: 'Install patch',
    installAsPatch: 'Install as patch',
    installPatch: 'Install patch…',
    thisIsPatch: 'This is an aircraft patch',
    thisIsPatchHint: 'Overlay this archive onto an installed aircraft instead.',
    maybePatchTitle: 'No add-on detected',
    maybePatchMessage:
      'This archive is not a recognized add-on. Install it as a patch for an existing aircraft?',
    noArchive: 'No patch archive available.',
    reasonMatched: 'matches {count} existing files',
    reasonLivery: 'liveries folder',
    reasonNoAnchor: 'no anchor — defaults to aircraft root',
    reasonNoListing: 'could not inspect archive',
    confidence: {
      high: 'High',
      medium: 'Medium',
      low: 'Low',
  ...
  modal: {
    ...
    cslSyncInProgressTitle: 'X-CSL Sync In Progress',
    cslSyncInProgressMessage: 'X-CSL paths are currently syncing. Are you sure you want to close?',
    cslSyncInProgressWarning: 'Closing now may leave some X-CSL paths only partially synced',
  ...
  sceneryManager: {
    ...
    smartGroupUngrouped: 'Ungrouped',
    smartGroupPackageCount: '{count} packages',
    smartGroupKindCustom: 'Custom Group',
    ...
    smartGroupKindUngrouped: 'Ungrouped',
    manageCustomGroups: 'Custom Groups',
    assignToGroup: 'Assign to Group',
    removeFromGroup: 'Remove from Group',
    assignGroupSelectedHint: '{count} selected scenery packages will be assigned',
    customGroupRuleCount: '{count} rules',
    noCustomGroups: 'No custom groups yet',
    quickCreateGroup: 'Quick create group',
    customGroupNamePlaceholder: 'Group name',
    createAndAssign: 'Create & Assign',
    customGroupsPathScoped: 'Custom groups are saved separately for each X-Plane path.',
    createGroup: 'Create Group',
    customGroupManualCount: '{count} assigned',
    customGroupRules: 'Rules',
    addRule: 'Add Rule',
    noCustomRules: 'No rules yet',
    ruleModePrefix: 'Prefix',
    ruleModeContains: 'Contains',
    rulePatternPlaceholder: 'Folder name pattern',
    customGroupAssigned: '{count} scenery packages assigned',
    customGroupRemoved: '{count} scenery packages removed from group',
    customGroupCreated: 'Custom group created',
    customGroupDeleted: 'Custom group deleted',
  ...
  management: {
    ...
    acfToggleFailed: 'Failed to toggle ACF file',
    openFolderFailed: 'Failed to open folder',
    ...
    manageAcfFilesTitle: 'Manage ACF Files · {name}',
    manageAcfFilesHint: 'Toggle individual aircraft model files in this folder.',
    partialAcfState:
      'Some ACF files are enabled while others are disabled. The aircraft entry stays enabled while any variant remains active.',
    acfEnabled: 'Enabled',
    acfDisabled: 'Disabled',
  ...
  contextMenu: {
    ...
    manageAcfFiles: 'Manage ACF Files',
  ...
  logAnalysis: {
    ...
    cleanRendererCache: 'Clean renderer cache',
    rendererCacheCleaning: 'Cleaning cache...',
    rendererCacheCleanSuccess:
      'Renderer cache cleaned ({size}). X-Plane will rebuild it on next launch.',
  ...
  diskUsage: {
    ...
    outputCleanup: {
      ...
      subtitle:
        'Clean selected X-Plane Output caches and generated files. The top-level folders are kept in place.',
      loading: 'Loading cleanup items...',
      empty: 'No cleanup items found in Output.',
      refresh: 'Refresh rules',
      refreshing: 'Refreshing...',
      selectRecommended: 'Select recommended',
      cleanSelected: 'Clean {size}',
      cleaning: 'Cleaning...',
      available: 'Available',
      selected: 'Selected',
      fileCount: 'Files',
      files: 'files',
      source: '{source} v{version}',
      sourceEmbedded: 'Bundled',
      sourceRemote: 'Remote',
      notFound: 'Not found',
      noSelection: 'Select at least one cleanup item.',
      confirmTitle: 'Clean selected Output items?',
      confirmMessage:
        'This will permanently delete the contents of {count} selected item(s), freeing about {size}. The folders themselves will be preserved.',
      confirmClean: 'Clean now',
      cleanSuccess: 'Cleaned {size} across {count} file(s)',
      submitUnknown: 'Submit description',
      submitTitle: 'Describe unknown Output folder',
      expectedLevel: 'Expected level',
      descriptionLabel: 'Description',
      descriptionPlaceholder: 'Describe what creates this folder and whether it is safe to clean.',
      submit: 'Submit to GitHub',
      submitting: 'Submitting...',
      submitSuccess: 'Cleanup item description submitted',
      issueTitle: '[Output Cleanup] {name}',
      unknownDescription:
        'This Output folder is not in the supported cleanup catalog yet. You can still clean it, or submit a description so it can be classified.',
      levelRecommended: 'Recommended cleanup',
      levelCleanable: 'Cleanable',
      levelCautious: 'Cautious cleanup',
      levelUnknown: 'Unrecognized',
      warnings: {
        shadercache:
          'Renderer cache will be rebuilt automatically; the next launch or scenery load may be slower.',
        replays: 'Deleting this item will clear saved replay files.',
        fms_plans: 'Deleting this item will clear saved FMS flight plans.',
        screenshots: 'Deleting this item will clear simulator screenshots and videos.',
        situations: 'Deleting this item will clear saved flight situations.',
      },
      items: {
        shadercache: {
          name: 'Renderer shader cache',
          description:
            'Compiled renderer and Vulkan shader cache. X-Plane rebuilds it automatically after cleanup.',
        },
        caches: {
          name: 'Runtime caches',
          description: 'General runtime and add-on cache files.',
        },
        real_weather: {
          name: 'Real weather cache',
          description: 'Downloaded or generated real weather cache files.',
        },
        log_archive: {
          name: 'Log archive',
          description: 'Archived historical X-Plane logs.',
        },
        crash_reports: {
          name: 'Crash reports',
          description: 'Old crash report files.',
        },
        diagnostic_reports: {
          name: 'Diagnostic reports',
          description: 'Old diagnostic report files.',
        },
        analytics: {
          name: 'Analytics data',
          description: 'Session analytics generated by X-Plane.',
        },
        autodgs: {
          name: 'AutoDGS data',
          description: 'AutoDGS generated data and cache files.',
        },
        logbooks: {
          name: 'Logbooks',
          description: 'X-Plane logbook files.',
        },
        backgrounds: {
          name: 'Background images',
          description: 'Images used as X-Plane background screens.',
        },
        replays: {
          name: 'Replays',
          description: 'Saved replay files.',
        },
        fms_plans: {
          name: 'FMS plans',
          description: 'Saved FMS flight plans.',
        },
        screenshots: {
          name: 'Screenshots and videos',
          description: 'Simulator screenshots and captured videos.',
        },
        situations: {
          name: 'Situations',
          description: 'Saved flight situations.',
        },
      },
    },
  },
  ...
  airportFlatten: {
    navTitle: 'Airport Flatten',
    title: 'Airport Flatten Manager',
    subtitle:
    ...
    customSource: 'Custom',
    customCount: 'Custom x{count}',
    searchEmpty: 'No matching airports were found.',
    targetSubtitle: 'Sources for {icao}',
    multiSourceHint:
      'Multiple sources were found for this ICAO. Choose the exact apt.dat you want to modify.',
    loadingTargets: 'Loading airport sources...',
    stateOn: 'Flatten On',
    stateOff: 'Flatten Off',
    pathLabel: 'apt.dat',
    ...
    toggleFailed: 'Failed to update flatten state',
    enableSuccess: '{icao} flatten enabled',
    disableSuccess: '{icao} flatten disabled',
    openPage: 'Open Flatten Page',
    savedListTitle: 'Saved Flatten States',
    savedListHint:
      'Airports you have toggled are saved here. When on-disk state drifts from what you saved, you can re-apply with one click.',
    savedListEmpty: 'No saved flatten states yet. Toggle an airport to start tracking it.',
    loadOverridesFailed: 'Failed to load saved flatten states',
    driftBanner: '{count} saved airport(s) drifted from desired state',
    driftBannerMissing: '{count} source(s) missing — will be skipped',
    applyAll: 'Apply All',
    applyingAll: 'Applying...',
    applyAllSuccess: 'Re-applied flatten on {count} airport(s)',
    applyAllPartial: 'Re-applied {applied}, {failed} failed',
    applyAllNoop: 'All saved airports already match their desired state',
    applyAllFailed: 'Failed to apply saved flatten states',
    reapply: 'Re-apply',
    reapplySuccess: '{icao} re-applied',
    removeSaved: 'Remove',
    removeSavedConfirmTitle: 'Remove saved flatten record?',
    removeSavedConfirmMessage:
      'This only removes the saved record for {icao}. The apt.dat file will not be modified.',
    removeSavedConfirm: 'Remove',
    removeSavedFailed: 'Failed to remove saved flatten record',
  ...
  csl: {
    navTitle: 'X-CSL',
    title: 'X-CSL Model Management',
    description: 'Manage X-Plane multiplayer X-CSL model packages',
    checking: 'Checking...',
    notInstalled: 'Not Installed',
    ...
    cslPaths: 'X-CSL Paths',
    autoDetected: 'Auto-detected',
    custom: 'Custom',
    default: 'Default',
    addPath: 'Add Path',
    removePath: 'Remove Path',
    setAsInstallPath: 'Set as install path',
    installPathActive: 'Install target',
    resetToDefault: 'Reset to default',
    installLocationChanged:
      'Install location updated. Existing packages at the previous location were not moved — uninstall or move them manually if needed.',
    serverSettings: 'Server Settings',
    serverSettingsTitle: 'X-CSL Server Settings',
    serverSettingsHint:
    ...
    noPathsDetected: 'No X-CSL paths detected. Please set X-Plane path first.',
    filterAll: 'All',
    ...
    fetchError: 'Failed to fetch X-CSL index',
    ...
    syncDialogTitle: 'Syncing X-CSL Paths',
    syncPreparing: 'Preparing sync...',
    syncInProgress: 'Applying file links to X-CSL paths',
    ...
    syncError: 'Failed to sync X-CSL paths',
    progress: 'Progress: {current}/{total} files',
  },
  altitude: {
    title: 'ALTITUDE Client',
    description: 'Manage IVAO ALTITUDE X-CSL model packages',
    scanning: 'Scanning index...',
    refresh: 'Refresh',
    install: 'Install',
    update: 'Update',
  ...
  doctor: {
    ...
    runDiagnostics: 'Run Health Check',
    running: 'Scanning...',
    rerun: 'Re-run Check',
    lastRun: 'Last checked {time}',
    overallHealth: 'Overall Health',
    healthOk: 'All Clear',
    healthInfo: 'Info',
    healthWarning: 'Warnings Found',
    healthCritical: 'Critical Issues',
    sections: {
      integrity: 'Installation Integrity',
      crashes: 'Crashes & Stability',
