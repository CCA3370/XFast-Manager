export default {
  ...
  sceneryManager: {
    ...
    contributeLinkDesc: 'Enter a valid download URL. The app opens a GitHub submission page for maintainer review.',
    ...
    contributionOpened: 'GitHub submission page opened',
