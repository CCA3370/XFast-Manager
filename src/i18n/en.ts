export default {
  ...
  presets: {
    ...
    navTitle: 'Presets',
    subtitle: 'Save and restore addon, scenery, Lua, and lock states',
    ...
    applyMessage:
      'Apply preset "{name}"? This will restore addon, scenery, Lua, and lock states to the preset snapshot.',
    updateSnapshotTitle: 'Update Snapshot',
    updateSnapshotMessage:
      'Update preset "{name}" with the current addon, scenery, Lua, and lock states?',
